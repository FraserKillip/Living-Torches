...
public class ConfigurationHandler {
    ...
    private static void loadConfiguration()
    {
        ...
        Settings.General.doFallOfWalls = configuration.getBoolean(Messages.Configuration.GENERAL_DO_FALL_OFF_WALLS, Configuration.CATEGORY_GENERAL, true, StatCollector.translateToLocal(Messages.Configuration.GENERAL_DO_FALL_OFF_WALLS_COMMENT), Messages.Configuration.GENERAL_DO_FALL_OFF_WALLS_LABEL);
        Settings.General.fallChance = configuration.getFloat(Messages.Configuration.GENERAL_FALL_CHANCE, Configuration.CATEGORY_GENERAL, 0.001f, 0f, 1f, StatCollector.translateToLocal(Messages.Configuration.GENERAL_FALL_CHANCE_COMMENT), Messages.Configuration.GENERAL_FALL_CHANCE_LABEL);
